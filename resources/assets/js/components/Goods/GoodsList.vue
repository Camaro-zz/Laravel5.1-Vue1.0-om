                ...
                <div class="col-sm-12">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" v-bind:data-page-size="page_size">
                                <thead>
                                <tr>
                                    <th data-toggle="true" data-sort-ignore="true">英文品名</th>
                                    <th data-sortable="false" data-sort-ignore="true">中文品名</th>
                                    <th data-sortable="false" data-sort-ignore="true">产品编号</th>
                                    <th data-sortable="false" data-sort-ignore="true">类目</th>
                                    <th data-sortable="false" data-sort-ignore="true">采购价(含税)</th>
                                    <th data-sortable="false" data-sort-ignore="true">采购价(不含税)</th>
...
export default{
    ...
    methods:{
        getGoodes(){
            ...
            this.$http.get('/goods.json?en_name='+en_name+'&cn_name='+cn_name+'&cat_id='+cat_id).then(function(response){
